...
include("source/samples/nvigi.basic.cxx/asr/premake.lua")
include("source/samples/nvigi.basic.cxx/gpt/premake.lua")
include("source/samples/nvigi.basic.cxx/tts/premake.lua")
include("source/samples/nvigi.basic/premake.lua")
include("source/samples/nvigi.codeagentlua/src/premake.lua")
