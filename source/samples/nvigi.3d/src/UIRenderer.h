...
private:
    ...
    std::shared_ptr<RegisteredFont> m_font_small = nullptr;
    std::shared_ptr<RegisteredFont> m_font_medium = nullptr;
    std::shared_ptr<RegisteredFont> m_font_large = nullptr;
    UIData& m_ui;
...
public:
    UIRenderer(DeviceManager* deviceManager, std::shared_ptr<NVIGISample> app, UIData& ui)
        ...
        m_font_small = this->CreateFontFromFile(*(app->GetRootFs()), "/media/fonts/DroidSans/DroidSans-Mono.ttf", 16.f);
        m_font_medium = this->CreateFontFromFile(*(app->GetRootFs()), "/media/fonts/DroidSans/DroidSans-Mono.ttf", 20.f);
        m_font_large = this->CreateFontFromFile(*(app->GetRootFs()), "/media/fonts/DroidSans/DroidSans-Mono.ttf", 25.f);
...
protected:
    ...
    virtual void buildUI(void) override
    {
        ...
        ImGui::PushFont(m_font_medium->GetScaledFont());
