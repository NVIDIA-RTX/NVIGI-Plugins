...
// Add DeviceManagerOverride support
#if DONUT_WITH_VULKAN
// External function from DeviceManagerOverride.cpp
extern donut::app::DeviceManager* CreateVK();
#endif
...
donut::app::DeviceManager* CreateDeviceManager(nvrhi::GraphicsAPI api)
{
    ...
    {
        return CreateVK(); // Use your override for Vulkan
    }
#endif
    return donut::app::DeviceManager::Create(api); // Use standard for other APIs
}
