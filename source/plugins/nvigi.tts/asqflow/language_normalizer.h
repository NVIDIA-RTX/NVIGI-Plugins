...
#include "source/plugins/nvigi.tts/asqflow/symbols.h"
...
class LanguageNormalizer
{
  public:
    ...
    virtual std::vector<std::string> splitSentences(std::string &text) = 0;
};
...
class EnglishNormalizer : public LanguageNormalizer
{
  public:
    ...
    std::vector<std::string> splitSentences(std::string &text) override;
  ...
  private:
    ...
    size_t minSizeChunk = 128;
	size_t maxSizeChunk = 256;
