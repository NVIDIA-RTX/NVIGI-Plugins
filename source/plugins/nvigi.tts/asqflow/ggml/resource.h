...
#define VER_FILEDESCRIPTION_STR     "NVIGI.TTS.ASQFLOW-GGML PLUGIN - " DISTRIBUTION_INFO
#define VER_INTERNALNAME_STR        "NVIGI.TTS.ASQFLOW-GGML"
#define VER_LEGALCOPYRIGHT_STR      "Copyright 2025 NVIDIA CORP"
